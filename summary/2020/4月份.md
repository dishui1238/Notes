<!--
 * @Author: your name
 * @Date: 2020-08-12 16:35:07
 * @LastEditTime: 2020-12-25 15:24:42
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \0dailyUpdateNotes\Notes\Summary\2020\4月份.md
-->
## 1. 创建包含 N 个空对象的数组
...
- 命令行 cmd `npm install -g increase-memory-limit`
- 进入项目文件夹 `increase-memory-limit`

或者

![](images/image_1608879041842.png)

原理一样,其实 increase-memory-limit 源码里面做的操作也是这样的，设置了 node-space-size

![](images/image_16088790912537.png)
